...
namespace EventHubAggregatorToHBaseTopology.Bolts
{
    ...
    class EventHBaseWriter : EventReAggregator
    {
        ...
        /// You can also refer to HBase SDK Samples here on how each filter is used: https://github.com/hdinsight/hbase-sdk-for-net/tree/master/Microsoft.HBase.Client.Tests
        /// </summary>
