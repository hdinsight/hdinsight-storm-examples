...
.EXAMPLE 
  .\kafka-installer-v01.ps1 -KafkaBinaryZipLocation https://hdiconfigactions.blob.core.windows.net/kafkaconfigactionv01/kafka_2.11-0.8.2.1.zip -KafkaHomeName kafka_2.11-0.8.2.1
#> 
...
if ((Test-Path $KafkaHome) -and (Test-Path $KafkaServerStart))
{
...
$brokerList = "headnode0.${kafkaDnsDomain}:9092,headnode1.${kafkaDnsDomain}:9092";
...
{ 
	...
	$brokerList = ("{0},{1}.{2}:9092" -f $brokerList, $kafkaHost, $kafkaDnsDomain)
}
