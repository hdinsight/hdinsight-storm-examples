...
namespace AzureHDInsightHBaseWriterStormApplication
{
    ...
    /// </summary>
    public class VehicleRecordGeneratorSpoutForHBase : ISCPSpout
    {
        Context context;
        long seqId = 0;
        ...
        public VehicleRecordGeneratorSpoutForHBase(Context context, Dictionary<string, object> parms = null)
        {
            //Set the context
        ...
        public static VehicleRecordGeneratorSpoutForHBase Get(Context context, Dictionary<string, Object> parms)
        {
            return new VehicleRecordGeneratorSpoutForHBase(context, parms);
        }
        ...
        public static List<string> OutputFields = new List<string>() { 
            "VIN", "Timestamp", "Make", "Model", "Year", "Odometer", "Status" };
